                                ...
                                <tbody>
                                    <?php $no=1; foreach($getAllBerkas as $gab):?>
                                        <tr>
                                            ...
                                            <td><?=$gab["FADESB1"];?></td>
                                            <td><?=$gab["LMDESA2"];?></td>
                                            <?php if($gab["FAALOC"] == "445.00001.00001") {?>
                                                <td><center>
                                                    <!-- DETAIL -->
                                                    ...
                                                    <!-- MUTASI -->
                                                    <a href="<?=base_url()?>BerkasBaru/Mutasi/<?=$gab["FAICU"];?>" class="pd-setting-ed" title="Mutasi"><span class="badge badge-dark"><i class="fa fa-sign-out-alt"></i></span></a>
                                                    </center>
                                                </td>
                                            <?php } else {?>
                                                <td><center>
