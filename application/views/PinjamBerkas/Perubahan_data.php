                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-4">
                                                ...
                                                <input type="text" class="form-control" name="ITIDBUID" value="<?=$perubahan["FAIDBUID"];?>" style="background-color:#f2f2f2;" disabled>
                                            </div>
                                            <div class="form-group col-md-4">
                                            ...
                                            <div class="form-group col-md-4">
                                                ...
                                                <input type="text" class="form-control" name="ITLOCID" value="<?=$perubahan["FAALOC"];?>" style="background-color:#f2f2f2;" disabled>
                                            </div>
                                        </div> 
                                        <div class="form-row">
                                            <div class="form-group col-md-4">
                                                <label style="color:#313236">Jenis Berkas</label>
                                                <input type="text" class="form-control" name="ITMSTY" value="<?=$perubahan["OVMSTY"];?>" style="background-color:#f2f2f2;" disabled>
                                            </div>
                                            <div class="form-group col-md-4">
                            ...
                            <div class="basic-form">
                                <form action="<?=base_url('PinjamBerkas/Perubahan/'.$perubahan['FAICU'].'/'.$perubahan['ITDOCNO'])?>" method="post">
                                    <div class="card-body">
                                        ...
                                        <?php endif; ?>
                                        <center><h4 class="card-tFAle" style="margin-top:-10px;">PERUBAHAN DATA</h4></center><br>
                                        <input type="hidden" name="ITCOID" value="<?=$perubahan["FACOID"];?>">
                                        <input type="hidden" name="ITICU" value="<?=$perubahan["FAICU"];?>">
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-4">
                                                ...
                                                <input type="text" class="form-control" name="ITCITY" value="<?=$perubahan["FACITY"];?>" style="background-color:#f2f2f2;" disabled>
                                            </div>
                                            <div class="form-group col-md-4">
                                                <label style="color:#313236">Kecamatan</label>
                                                <input type="text" class="form-control" name="ITDIST" value="<?=$perubahan["FADIST"];?>" style="background-color:#f2f2f2;" disabled>
                                            </div>
                                            <div class="form-group col-md-4">
                                                <label style="color:#313236">Desa</label>
                                                <input type="text" class="form-control" name="ITSUBDIST" value="<?=$perubahan["FASUBDIST"];?>" style="background-color:#f2f2f2;" disabled>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group row">
